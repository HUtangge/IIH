...
# Parameter_file name should contain modality information
parameter_file = 'volumetrics_forall_IIH_25112023.csv' 
newfile_name = 'withinfo_volumetrics_forall_IIH_25112023.csv'
